describe('Party Horn Tests', () => {
  ...
  it('Image & Sound sources change when party horn selected', () => {
  ...
  it('volume image changes from mute to 1 bar', () => {
    cy.get('#volume-slider')
      .invoke('val', 0)
      .trigger('input');
    cy.get('#volume-image').then($el => {
  ...
  it('volume image changes from 1 to 2 bars', () => {
    cy.get('#volume-slider')
      .invoke('val', 33)
      .trigger('input');
    cy.get('#volume-image').then($el => {
  ...
  it('volume image changes from 2 to 3 bars', () => {
    cy.get('#volume-slider')
      .invoke('val', 66)
      .trigger('input');
    cy.get('#volume-image').then($el => {
  ...
  it('honk button is disabled for empty or non-number input', () =>{
  ...
  it('error shown when number is outside of the given range', () => {
